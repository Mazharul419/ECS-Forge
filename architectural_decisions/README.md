...
| Private connectivity | Least-privilege security groups | Over-permissive network | Secure: Only required resources allowed to talk to each other at EVERY path |
